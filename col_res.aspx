<%@ Page Language="C#" AutoEventWireup="true" CodeFile="col_res.aspx.cs" Inherits="col_res" %>
...
<body class="gray-bg">
    ...
    <div style="width:100%;height:48px;background-color:#ffffff;margin-bottom:20px">
       ...
       <div style="height:10px">&nbsp</div>
           <asp:Label ID="Label1" runat="server" Text="收藏的资源" style="background-color:#1AB394;color:#ffffff;"></asp:Label>
       </div>
       </a>
