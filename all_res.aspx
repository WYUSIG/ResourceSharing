<%@ Page Language="C#" AutoEventWireup="true" CodeFile="all_res.aspx.cs" Inherits="all_res" %>
...
<body class="gray-bg">
    ...
    <div style="width:100%;height:48px;background-color:#ffffff;margin-bottom:20px">
       ...
       <div style="height:10px">&nbsp</div>
           <asp:Label ID="Label1" runat="server" Text="世界资源" style="background-color:#1AB394;color:#ffffff;"></asp:Label>
       </div>
       </a>
