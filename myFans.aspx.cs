...
public partial class myFans : System.Web.UI.Page
{
    ...
    {
        String selectsql = "SELECT concern FROM [user],subscribe WHERE concerned=[user].id AND phone='" + phone + "' AND concern!=concerned";
        try
        {
